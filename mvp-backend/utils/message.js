...
<html lang="en">
  ...
  <body>
    ...
    <h1>Welcome to be safe website</h1>
    ...
    <footer>
      <div class="connect">
        <p>
          <b>
          We're thrilled to welcome you to be safe family!<br> this where government is going to be yours completely .<br>

          
          Here's what you can look forward to as a Nectaus member: <br>Best regards,
          </b>
        </p>
      </div>
    </footer>
